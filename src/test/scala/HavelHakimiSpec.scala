...
class HavelHakimiSpec extends AnyFlatSpec with should.Matchers{
 def hh(ls: List[Int]) ={
  ...
  "hh function " should "return false for input : List(14, 10, 17, 13, 4, 8, 6, 7, 13, 13, 17, 18, 8, 17, 2, 14, 6, 4, 7, 12)" in {
    hh(List(14, 10, 17, 13, 4, 8, 6, 7, 13, 13, 17, 18, 8, 17, 2, 14, 6, 4, 7, 12)) shouldBe false
  }
